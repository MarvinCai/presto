        ...
        implements AutoCloseable
{
    ...
    private long entryQueueDequeueWaitTimeSum;
    private long bytesReadSum;
    ...
    private long messageQueueEnqueueWaitTimeSum;
    private long numMessagesDerserializedSum;
    private long numMessagedDerserializedPerBatch;
    private long readAttemptsSuccessSum;
    private long readAttemptsFailSum;
    private long readLatencySuccessSum;
    private long readLatencyFailSum;
    private long numEntriesPerBatchSum;
    private long messageQueueDequeueWaitTimeSum;
    private long recordDeserializeTimeStartTime;
    private long recordDeserializeTimeSum;

    public PulsarConnectorMetricsTracker(StatsProvider statsProvider)
    {
        statsLogger = statsProvider instanceof NullStatsProvider
